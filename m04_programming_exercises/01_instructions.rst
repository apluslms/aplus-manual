...
The file ``m04_programming_exercises/02_hello_world.rst`` is a sample page
...
If all these fail, one can run a shell :doc:`inside the grading container
</m04_programming_exercises/04_debugging_in_container>`.
