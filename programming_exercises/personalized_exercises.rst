...
The shell script `pregenerate-exercises.sh <https://github.com/apluslms/aplus-manual/blob/master/pregenerate-exercises.sh>`_
...
`pregenerate-exercises.sh <https://github.com/apluslms/aplus-manual/blob/master/pregenerate-exercises.sh>`_
...
path ``/local/grader/ex-meta/<course_key>/pregenerated/<exercise_key>/``. (Reference: mooc-grader
source: `access/management/commands/pregenerate_exercises.py <https://github.com/apluslms/mooc-grader/blob/master/access/management/commands/pregenerate_exercises.py>`_
, `util/personalized.py <https://github.com/apluslms/mooc-grader/blob/master/util/personalized.py>`_ .)
...
will call the **generator.py** script of the exercise first with a command line
