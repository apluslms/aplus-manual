...
.. admonition:: Software: Python
  ...
  `Python programming language <https://www.python.org/>`_. Knowing Python
  is not required for writing course material or making exercises (unless
  they are Python programming exercises). Installing Python is not necessary
  either, as it will run inside Docker, as will be later shown.
