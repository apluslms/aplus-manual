...
.. styled-topic::
  ...
  Main questions:
    How to create questionnaires in A+?

  Topics:
    In this section, we will talk about:

    * `General description of the options`_
    * `Examples`_
...
* ``class``: :doc:`CSS class </m03_rst_guide/06_styling>`
...
.. figure:: /images/questionnaire/summary-freetext-float.png
   ...
   **Figure:** *the summary of a float-freetext questionnaire*. In this case, 304
   ...
   have an incorrect answer having a value between 1.4 and 1.6.
...
.. figure:: /images/questionnaire/summary-freetext-string.png
  ...
  **Figure:** *the summary of a string-freetext questionnaire*. The answer
  is an SQL query, and A+ shows an unique answers. There are four identical
